...
const guesses_taken = computed(() => 4 - guesses_remaining.value);
...
<template>
  <main>
    <div class="flex flex-col align-center justify-bottom">
      ...
      You guessed in {{ guesses_taken }} guess<span v-if="guesses_taken > 1">es</span>!
      </p>
